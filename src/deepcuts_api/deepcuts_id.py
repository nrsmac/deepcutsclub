...
def get_isrc_from_apple_music_track_link(apple_music_link: str) -> str:
    """Extract the ISRC from an Apple Music URI."""
    raise NotImplementedError("Apple Music is not yet implemented.")


def get_upc_from_apple_music_album_link(apple_music_link: str) -> str:
    """Extract the UPC from an Apple Music URI."""
    raise NotImplementedError("Apple Music is not yet implemented.")
...
def get_unique_id_from_apple_music_link(apple_music_link: str) -> str:
    """Extract the unique identifier from an Apple Music URI."""
    raise NotImplementedError("Apple Music is not yet implemented.")
