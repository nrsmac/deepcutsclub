...
class GetArtistAlbumsResponse(BaseModel):
    """
    Schema for an album_response.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetArtistAlbumsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetArtistAlbumsResponse:
        """Create an instance of GetArtistAlbumsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetArtistAlbumsResponse.parse_obj(obj)

        _obj = GetArtistAlbumsResponse.parse_obj(
            {
